...
ppath = find_path('FR', 'DU')

print ppath
        

X.node[ppath[0]]['stime'] = 0
X.node[ppath[0]]['interval'] = 15
tlist = []
...
X.node[ppath[2]]['stime'] = 5
X.node[ppath[2]]['interval'] = 15
#assume
t2list = []
...
delay = X.node[ppath[0]]['interval'] - start

X.edge[ppath[0]][ppath[1]]['time'] = delay
totaldist = delay + middist

#BF train starts at 20
...
X.edge[ppath[2]][ppath[3]] = delay2

totaldist = delay2 + totaldist + 17
