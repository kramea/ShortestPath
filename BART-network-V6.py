...
BTICKT.add_weighted_edges_from([('FR', 'BF', 1.75), ('FR', 'WO', 4.10), ('FR', 'EM', 5.60), ('FR', 'DC', 6.00), ('FR', '12', 4.00), ('FR', 'RC', 4.85), ('DU', 'BF', 1.75), ('DU', 'WO', 4.10), ('DU', 'EM', 5.55), ('DU', 'DC', 6.00), ('RC', '12', 2.60), ('RC', 'WO', 2.75), ('RC', 'EM', 4.25), ('RC', 'DC', 4.65), ('PB', '12', 4.30), ('PB', 'WO', 4.45), ('PB', 'EM', 5.95), ('PB', 'DC', 6.35), ('DC', 'EM', 2.95), ('DC', 'WO', 3.75), ('DC', 'BF', 4.75), ('DC', '12', 3.80), ('BF', 'WO', 2.75), ('BF', 'EM', 4.30), ('BF', '12', 2.60), ('BF', 'RC', 3.60), ('WO', 'EM', 2.90), ('WO', '12', 1.75),('EM', '12', 3.10)])
...
#check if you have included EM to WO in C network
#Time Weightages
...
cartime = C.edge['FR']['BF']['weight']['time']
cardist = C.edge['FR']['BF']['weight']['dist']
...
#print ctime_cost, btime_cost
"""
carp_time = cartime + 15
carp_timecost = carp_time * vot[1] """

carfuel = ((4.0/30)*cardist) + (cardist*(1.4)) + 15 + 5
#carpool = (((4.0/30)*cardist) + (cardist*(1.4)) + 17.5)/3 

bart_cost = btime_cost + 1.75
car_cost = ctime_cost + carfuel
#carp_cost = carp_timecost + carpool

print car_cost, bart_cost
