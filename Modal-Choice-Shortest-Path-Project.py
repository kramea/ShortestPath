...
#BART network--distance and time
...
#BART ticket cost for each O-D path
...
#Function to calculate distances between the two points
...
#This function adds additional nodes to the selected BART path
...
for start in range(0,15,1):  
    ...
    vot = numpy.array([2.87, 7.45, 12.84, 20.58, 44.17, 74.92]) #value of time for different income groups
    parking = 15
    toll = 5
    oakpark = 12
    ...
    bart_cost = btime_cost + BTICKT.edge[O][D]['weight']
